...
echo $B."\n::#:Recode ::[CyberNET_DeepSky]#";

echo $RR."\n::#:Github ::[http://github.com/cnet12:] #";

echo $R."\n::#:SCRIPT BY ::MATAMU123:] #";

echo $G."\n::# 鈥⑩€⑩€⑩€⑩€NTUK MEMULAI KETIK : 鈥⑩€⑩€⑩€⑩€� #";

echo $GG."\n:: CONTOH: php dor.php 6285230876556 lalu enter";

echo $YY."\n::#: #";

echo $R."\n::###########[RECODE BY CYBER_NET SKYDEEPMIND]###########";

echo $B."\n::###############################################".$G.$X."\n\n";

isset($argv[1]) OR die($RR."[!] UNTUK MEMULAI, SILAHKAN KETIK SEPERTI INI = 
php dor.php 628xxxxx(nomor anda) lalu Enter [!]\n".$X);

if(is_numeric($argv[1])) {

	echo "[] Memverifikasi kode OTP, Harap Tunggu!!![] #".$G.$argv[1].$X."\n";
...
echo "[] Serv ID Sedang Diproses[] #".$G.$argv[2].$X."\n";
...
echo "[]RASAKAN KESEGARANNYA ->[] # ".$G.$argv[2].$X."\n";
